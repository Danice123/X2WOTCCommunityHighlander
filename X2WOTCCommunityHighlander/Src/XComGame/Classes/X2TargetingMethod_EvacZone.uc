...
static function bool ValidateEvacArea( const out TTile EvacCenterLoc, bool IncludeSoldiers )
{
	...
	local int IsOnFloor;
	local XComWorldData WorldData; // Added Issue #165
	...
	WorldData = `XWORLD; // Added Issue #165
	...
	while (TestTile.X <= EvacMax.X)
	{
		...
		{
			// Issue #165: Reject any evac zone that has any tile out of bounds of the map.
